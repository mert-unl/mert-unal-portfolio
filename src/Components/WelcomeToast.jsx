...
function acceptClick(){
  ...
  return (
    <div className={`${flag ?"display:none hidden " :"fixed inset-0 flex flex-col items-center justify-center z-[1000] bg-black " }`}>
...
/>
      ...
      <div className="bg-black/20 text-white rounded-xl shadow-xl fixed  p-12 flex flex-col mb-25 items-center gap-10 max-w-sm w-full">
        ...
        <div className="flex flex-row gap-4  mt-4">
          <button onClick={acceptClick} className="bg-gray-900   rounded-lg  text-4xl hover:bg-blue-600 text-white hover:scale-260 font-semibold px-6 py-4  duration-500 transition-all">
            Evet
          </button>
